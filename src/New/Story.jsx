...
function Story() {
    ...
    const handleBookClick = (item) => {
        if (!isLoggedIn) {
            ...
            navigate("/Login", { state: { from: '/Story' } }); // Pass the current page for redirection after login
        } else {
    ...
    return (
        <>
            ...
            <div className="mt-28 items-center justify-center text-center">
                <h1 className="text-2xl font-semibold md:text-4xl items-center justify-center text-center mt-28">Story Books</h1>
            </div>
